...
static bool do_future(int player)
{
    ...
    case 1:
    {
        ...
        if(player == 0)
            name = (english ? "Enemy " : "����́@") + name;
        auto msg = name + (english ? " was hit by a bomb!" : " �� ���e�� ���������I");
...
static int do_resheal(int player)
{
    ...
    case 2:
    {
        ...
        constexpr auto jpheal = "�́@�A�u�\�[�o�[��\\n�̗͂��@�񕜂����I";
        constexpr auto endrain = " has lost HP due to Suzaku!";
        constexpr auto jpdrain = "�� �鐝��\\n�̗͂� �D��ꂽ�c�c";
        auto name = std::string(otherstate->active_nickname);
        bool english = tpdp_eng_translation();
...
int do_form_change(int player, int pid, int style, bool switchin)
{
    ...
    case 5:
    {
        ...
        if(player != 0)
            name = (english ? "Enemy " : "����́@") + name;
        if(set_battle_text(name + (english ? " has changed appearance!" : "�� �p���ς�����I")) != 1)
        {
            if(++_frames > get_game_fps())
            {
                _frames = 0;
...
static int do_curse(int player)
{
    ...
    case 2:
    {
        ...
        if(player != 0)
            name = (english ? "Enemy " : "����́@") + name;
        auto msg = name + (english ? " has been cursed!" : " �͎���Ă��܂����I");
...
void init_misc_hacks()
{
    ...
    if(tpdp_eng_translation())
        ...
        patch_memory(RVA(0x4335e8), "�X�y�V����", 11);
